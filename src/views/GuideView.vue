...
<template>
  <div class="guide-page">
    ...
    <main class="guide-content">
      <section class="guide-hero">
        <div>
          ...
          <p>Panduan langkah demi langkah untuk Ketua RT dan Ketua RW, mulai dari memeriksa dashboard sampai menyiapkan
            laporan.</p>
        </div>
      ...
      <section class="guide-role-picker" aria-label="Pilih panduan berdasarkan role">
        <button :class="{ active: activeRole === 'ketua_rt' }" type="button" @click="activeRole = 'ketua_rt'">
          <span>RT</span>
          <div><strong>Ketua RT</strong><small>Kelola KK dan warga RT</small></div>
        </button>
        <button :class="{ active: activeRole === 'ketua_rw' }" type="button" @click="activeRole = 'ketua_rw'">
          <span>RW</span>
          <div><strong>Ketua RW</strong><small>Pantau seluruh RT dalam RW</small></div>
        </button>
      </section>

      <section class="guide-intro-card">
        <div>
          <p class="eyebrow">Panduan aktif</p>
        ...
        <div class="guide-sections">
          <section id="mulai" class="guide-section">
            ...
            <div>
              ...
              <div class="guide-tip"><strong>Tip</strong>Gunakan akun pribadi. Jangan menggunakan akun Ketua RT/RW lain
                meskipun berada di wilayah yang sama.</div>
            </div>
          </section>
          ...
          <section id="dashboard" class="guide-section">
            ...
            <div>
              ...
              <template v-if="activeRole === 'ketua_rt'">
                <p>Dashboard Ketua RT hanya berisi data RT Anda. Gunakan untuk memeriksa:</p>
                <ul>
                  <li>Total KK dan warga yang sudah terdaftar.</li>
                  <li>Komposisi jenis kelamin dan status penduduk.</li>
                  <li>Kelompok usia untuk kebutuhan layanan warga.</li>
                  <li>Tren lahir, meninggal, pindah, dan datang selama enam bulan.</li>
                </ul>
              </template>
              <template v-else>
                <p>Dashboard Ketua RW merangkum seluruh RT dalam RW Anda. Gunakan untuk:</p>
                <ul>
                  <li>Membandingkan jumlah KK dan warga setiap RT.</li>
                  <li>Menemukan RT yang datanya belum lengkap atau berbeda jauh.</li>
          ...
          <section v-if="activeRole === 'ketua_rw'" id="wilayah" class="guide-section">
            ...
            <div>
              <h2>Mengelola RT dalam RW</h2>
              <ol>
                <li>Buka <strong>Master Wilayah</strong>.</li>
                <li>Klik <strong>Tambah Wilayah</strong> dan pilih jenis <strong>RT</strong>.</li>
                <li>Pilih RW induk yang tersedia, isi nama/nomor RT, lalu simpan.</li>
                <li>Gunakan Edit jika penamaan RT perlu diperbaiki.</li>
              </ol>
              <div class="guide-warning"><strong>Perhatian</strong>Jangan menghapus RT yang sudah memiliki KK atau warga
                sebelum
                data dependensinya ditangani.</div>
            </div>
          </section>
          ...
          <section id="kk" class="guide-section">
            ...
            <div>
              ...
              <div class="guide-tip"><strong>Pemeriksaan</strong>Pastikan nomor KK dan NIK diisi dengan benar dan tidak
                tertukar.
              </div>
            </div>
          </section>
          ...
          <section id="warga" class="guide-section">
            ...
            <div>
              <h2>Menambah dan memperbarui warga</h2>
              <ol>
                <li>Buka <strong>Data Warga</strong>, lalu klik <strong>Tambah Warga</strong>.</li>
                <li>Pada field Kartu Keluarga, ketik nomor KK, NIK anggota, atau nama kepala keluarga, kemudian pilih
                  hasilnya.
                </li>
                <li>Isi identitas warga dan hubungan dalam keluarga, lalu simpan.</li>
                <li>Gunakan tombol <strong>Lihat</strong>, <strong>Edit</strong>, atau <strong>Hapus</strong> pada baris
                  warga.
                </li>
              </ol>
              <div class="guide-warning"><strong>Sebelum menghapus</strong>Pastikan data warga memang salah/duplikat dan
                bukan
                warga yang seharusnya dicatat sebagai pindah atau meninggal.</div>
            </div>
          </section>
          ...
          <section id="lampid" class="guide-section">
            ...
            <div>
              <h2>Mencatat LAMPID</h2>
              <p>LAMPID digunakan untuk mencatat <strong>lahir, meninggal, pindah, dan datang</strong>.</p>
              <ol>
                <li>Dari halaman Data Warga, klik <strong>Catat LAMPID</strong>.</li>
                <li>Pilih warga, jenis kejadian, tanggal, dan isi catatan bila diperlukan.</li>
                <li>Simpan dan periksa perubahan pada dashboard serta laporan.</li>
              </ol>
              <p>Untuk kejadian pindah atau meninggal, sistem menandai tanggal keluar pada data warga tanpa
          ...
          <section id="keamanan" class="guide-section guide-section--compact">
            ...
            <div>
              <h2>Keamanan akun dan data</h2>
              <ul>
                <li>Jangan membagikan password melalui grup chat.</li>
                <li>Selalu klik <strong>Keluar</strong> setelah memakai perangkat bersama.</li>
                <li>Jangan mengubah atau menghapus data di luar dokumen pendukung yang sah.</li>
                <li>Laporkan segera jika akun dapat melihat wilayah yang bukan tanggung jawabnya.</li>
              </ul>
            </div>
          </section>
        </div>
    ...
    <footer class="guide-footer"><span>Data Warga RT/RW Digital</span>
      <RouterLink :to="appTarget">{{ appTargetLabel }} →</RouterLink>
    </footer>
  </div>
</template>
